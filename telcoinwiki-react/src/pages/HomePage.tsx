...
const homeNarrativeSections: HomeNarrativeSection[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        body: 'Telcoin doesn’t cut corners—it builds trust. TAN, the Telcoin Application Network, is where self-custodial wallet apps built by GSMA telecom members put the network and TELx to work for everyday users, under governance set by the Telcoin Association. Every feature is aligned with legal clarity and telecom-grade governance, without sacrificing user freedom.',
        href: '/deep-dive#deep-wallet',
        imageSrc: '/media/deep-dive/digital-cash/TAN.svg',
        imageAlt: 'Telcoin Application Network',
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        body: 'Short answers to the questions newcomers actually ask, each one linking through to the matching Deep Dive section when you want the full picture.',
        href: '/#faq-section',
        imageSrc: '/media/marquee/logos/icon-blockchain.svg',
